...
class InputParser {
     ...
     */
    InputParser(List exposed, LoggerDynamic logger, List parallel=[]) {
    ...
    private String envToMessage(final Map<String, String> env) {
        ...
        //logger.info("ENV message: " + message) 
        return message;
    }
     ...
     */
    public Map<String, List<String>> parse(String defaultInputs, Map env) {
        ...
        Map userInputs = parseFromMessage(messageFromEnv)
        if (messageFromEnv) {
